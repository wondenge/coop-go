...
func (c *APIClient) TransactionStatus(ctx context.Context, p *connect.FTTransactionStatusPayload) (res *connect.SuccessResponse, err error) {
	...
	if err := c.logger.Log("info", fmt.Sprintf("connect.TransactionStatus")); err != nil {
