...
// APIClient manages communication with the PesaLinkSendToPhone API v1.0.0
...
type APIClient struct {
	...
	PesaLinkSendToPhoneAPI *PesaLinkSendToPhoneService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.PesaLinkSendToPhoneAPI = (*PesaLinkSendToPhoneService)(&c.common)
