...
// APIClient manages communication with the AccountTransactions API v1.0.0
...
type APIClient struct {
	...
	AccountTransactionsAPI *AccountTransactionsService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AccountTransactionsAPI = (*AccountTransactionsService)(&c.common)
