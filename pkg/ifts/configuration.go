...
func NewConfiguration() *Configuration {
	cfg := &Configuration{
		BasePath:      "https://developer.co-opbank.co.ke:8243/FundsTransfer/Internal/A2A/2.0.0",
		...
		Servers: []ServerConfiguration{
			...
			{
				Url:         "http://developer.co-opbank.co.ke:8243/FundsTransfer/Internal/A2A/2.0.0",
				Description: "No description provided",
			},
		},
	}
