...
// IFTAccountToAccountService IFTAccountToAccountAPI service
type IFTAccountToAccountService service

/*
A2A Post an Internal Funds Transfer Account to Account Transaction
Internal Funds Transfer Account to Account API will enable you to transfer funds from your own Co-operative Bank account to other Co-operative Bank account(s)
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param iftAccountToAccountTxnRequest Internal Funds Transfer Send to Account Transaction Request Body
@return SuccessAcknowledgement
*/
func (a *IFTAccountToAccountService) A2A(ctx _context.Context, iftAccountToAccountTxnRequest IftAccountToAccountTxnRequest) (SuccessAcknowledgement, *_nethttp.Response, error) {
	var (
	...
	// body params
	postBody = &iftAccountToAccountTxnRequest
