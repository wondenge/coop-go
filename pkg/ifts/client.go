...
// APIClient manages communication with the IFTAccountToAccount API v2.0.0
...
type APIClient struct {
	...
	IFTAccountToAccountAPI *IFTAccountToAccountService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.IFTAccountToAccountAPI = (*IFTAccountToAccountService)(&c.common)
