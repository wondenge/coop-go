...
// APIClient manages communication with the AccountMiniStatement API v1.0.0
...
type APIClient struct {
	...
	AccountMiniStatementAPI *AccountMiniStatementService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AccountMiniStatementAPI = (*AccountMiniStatementService)(&c.common)
