...
// PesaLinkSendToAccountService PesaLinkSendToAccountAPI service
type PesaLinkSendToAccountService service

/*
A2A Post a PesaLink Funds Transfer Send to Account Transaction
PesaLink Send to Account Funds Transfer API will enable you to transfer funds from your own Co-operative Bank account to Bank account(s) in IPSL participating banks
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param pesaLinkSendToAccountTransactionRequest PesaLink Funds Transfer Send to Account Transaction Request Body
@return SuccessAcknowledgement
*/
func (a *PesaLinkSendToAccountService) A2A(ctx _context.Context, pesaLinkSendToAccountTransactionRequest PesaLinkSendToAccountTransactionRequest) (SuccessAcknowledgement, *_nethttp.Response, error) {
	var (
	...
	// body params
	postBody = &pesaLinkSendToAccountTransactionRequest
