...
// APIClient manages communication with the PesaLinkSendToAccount API v1.0.0
...
type APIClient struct {
	...
	PesaLinkSendToAccountAPI *PesaLinkSendToAccountService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.PesaLinkSendToAccountAPI = (*PesaLinkSendToAccountService)(&c.common)
