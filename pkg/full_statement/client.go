...
// APIClient manages communication with the AccountFullStatement API v1.0.0
...
type APIClient struct {
	...
	AccountFullStatementAPI *AccountFullStatementService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AccountFullStatementAPI = (*AccountFullStatementService)(&c.common)
