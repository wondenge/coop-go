...
// APIClient manages communication with the TransactionStatus API v2.0.0
...
type APIClient struct {
	...
	TransactionStatusAPI *TransactionStatusService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.TransactionStatusAPI = (*TransactionStatusService)(&c.common)
