...
// APIBase is a base API URL, for testing you can use connectapi.APIBaseSandBox
func NewClient(key string, secret string, APIBase string) (*Client, error) {
	if key == "" || secret == "" || APIBase == "" {
...
// If log file is set, we will log all requests and responses to this Writer
...
// SendWithBasicAuth makes a request to the API using key:secret basic auth
